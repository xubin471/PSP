...
def cfg():
    ...
    exclude_label = [1,2,3,4]  # None, for not excluding test labels; Setting 3: None, Setting 2: True
    # 3 for Liver, 2 for RK, 3 for LK, 4 for Spleen in 'CHAOST2'
    if dataset == 'Cardiac':
        n_sv = 1000
    ...
    # Network
    # reload_model_path = '.../ADNet/runs/ADNet_train_CHAOST2_cv0/3/snapshots/1000.pth'
    ...
    path = {
        ...
        # 'Prostate_NCI': {'data_dir': './data/Prostate/NCI/tcia_p3t_normalized'},
        # 'Prostate_UCL': {'data_dir': './data/Prostate/UCL/biopsy_normalized'},
        ...
        'MS-CMR': {'data_dir': './data/MS-CMR'},
    }

    # Settings of clip

    train_organ = [1, 6]  # 3: Spleen 6: Liver
